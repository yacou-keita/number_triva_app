...
// in number_triva_app/test/features/number_trivia/data/repositories/number_trivia_repository_impl_test.dart.
...
import 'package:number_triva_app/core/network/network_info.dart' as _i6;
...
class MockNumberTriviaRemoteDataSource extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.NumberTriviaModel> getConreteNumberTrivia(int? number) =>
      (super.noSuchMethod(
        Invocation.method(
...
class MockNumberTriviaLocalDataSource extends _i1.Mock
  ...
  @override
  _i4.Future<void> chacheNumberTrivia(_i2.NumberTriviaModel? triviaToCache) =>
      (super.noSuchMethod(
        Invocation.method(
          #chacheNumberTrivia,
          [triviaToCache],
